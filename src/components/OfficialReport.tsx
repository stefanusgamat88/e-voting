          ...
          <div className="border-b-4 border-double border-slate-900 pb-4 text-center relative font-sans">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="space-y-0.5 flex-1">
                <h3 className="text-xs sm:text-sm font-extrabold tracking-widest uppercase text-slate-700 font-sans">
                  {orgName}
                </h3>
                <h2 className="text-lg sm:text-2xl font-black tracking-tight uppercase text-slate-900 font-sans">
                  {schoolName}
                </h2>
